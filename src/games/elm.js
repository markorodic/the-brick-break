...
var _user$project$Constants$brickPoints = {low: 1, middle: 4, high: 7};
var _user$project$Constants$brickLayout = {numberOfBricks: 196, xMargin: 47, yMargin: 47, bricksPerLine: 14};
...
var _user$project$Messages$TickUpdate = function (a) {
	return {ctor: 'TickUpdate', _0: a};
};
var _user$project$Messages$KeyUp = function (a) {
	return {ctor: 'KeyUp', _0: a};
};
var _user$project$Messages$KeyDown = function (a) {
...
var _user$project$Model_Bricks$assignBrickPosition = F2(
	function (index, b) {
		var setRow = (index / _user$project$Constants$brickLayout.bricksPerLine) | 0;
		var y = (((index / _user$project$Constants$brickLayout.bricksPerLine) | 0) * b.size.height) + _user$project$Constants$brickLayout.yMargin;
		var x = (A2(_elm_lang$core$Basics$rem, index, _user$project$Constants$brickLayout.bricksPerLine) * b.size.width) + _user$project$Constants$brickLayout.xMargin;
		return _elm_lang$core$Native_Utils.update(
			b,
			{
				position: {x: x, y: y},
...
var _user$project$Model_Bricks$emptyBrickList = function () {
	var initialBricks = A2(
		_elm_lang$core$List$repeat,
		_user$project$Constants$brickLayout.numberOfBricks,
		{
			position: {x: 0, y: 0},
			size: {width: _user$project$Constants$brickAttributes.width, height: _user$project$Constants$brickAttributes.height},
			row: 0
		});
	return initialBricks;
}();
var _user$project$Model_Bricks$initBricks = function () {
	var positionedBricks = A2(_elm_lang$core$List$indexedMap, _user$project$Model_Bricks$assignBrickPosition, _user$project$Model_Bricks$emptyBrickList);
	return positionedBricks;
}();
var _user$project$Model_Bricks$Brick = F3(
	function (a, b, c) {
		return {position: a, size: b, row: c};
	});
var _user$project$Model_Bricks$Position = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$Model_Bricks$Size = F2(
	function (a, b) {
		return {width: a, height: b};
	});

var _user$project$Model_Game$InitGame = F3(
	function (a, b, c) {
		return {score: a, lives: b, state: c};
	});
var _user$project$Model_Game$Gameover = {ctor: 'Gameover'};
var _user$project$Model_Game$Play = {ctor: 'Play'};
...
var _user$project$Model$model = {paddle: _user$project$Model_Paddle$initPaddle, ball: _user$project$Model_Ball$initBall, bricks: _user$project$Model_Bricks$initBricks, game: _user$project$Model_Game$initGame};
var _user$project$Model$init = {ctor: '_Tuple2', _0: _user$project$Model$model, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Model$Model = F4(
	function (a, b, c, d) {
		return {paddle: a, ball: b, bricks: c, game: d};
	});

var _user$project$Update_Paddle$stopPaddle = function (paddle) {
	return _elm_lang$core$Native_Utils.update(
		paddle,
		{velocity: 0});
};
var _user$project$Update_Paddle$movePaddle = F2(
	function (paddle, updateVelocityFromInput) {
		return _elm_lang$core$Native_Utils.update(
			paddle,
			{velocity: updateVelocityFromInput});
	});
var _user$project$Update_Paddle$paddleCanMove = F2(
	function (position, velocity) {
		var paddleCanMoveLeft = (_elm_lang$core$Native_Utils.cmp(position, 5) > 0) && _elm_lang$core$Native_Utils.eq(velocity, -5);
		var paddlePositionEnd = (_user$project$Constants$gameAttributes.width - _user$project$Constants$paddleAttributes.width) - 6;
		var paddleCanMoveRight = (_elm_lang$core$Native_Utils.cmp(position, paddlePositionEnd) < 0) && _elm_lang$core$Native_Utils.eq(velocity, 5);
		return paddleCanMoveLeft || paddleCanMoveRight;
	});
var _user$project$Update_Paddle$addVelocityToPosition = function (paddle) {
	var _p0 = paddle;
	var position = _p0.position;
	var velocity = _p0.velocity;
	return A2(_user$project$Update_Paddle$paddleCanMove, position, velocity) ? (position + velocity) : position;
};
var _user$project$Update_Paddle$mapBallPositionToPaddlePosition = function (ball) {
	var _p1 = ball;
	var x = _p1.x;
	return x;
};
var _user$project$Update_Paddle$updatePaddle = function (model) {
	var _p2 = model;
	var paddle = _p2.paddle;
	var ball = _p2.ball;
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			paddle: _elm_lang$core$Native_Utils.update(
				paddle,
				{
					position: _user$project$Update_Paddle$mapBallPositionToPaddlePosition(ball.position) - 27
				})
		});
};

var _user$project$Keys$keyUp = F2(
	function (keyCode, model) {
		var _p0 = model;
		var paddle = _p0.paddle;
		var _p1 = keyCode;
		switch (_p1) {
			case 37:
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						paddle: _user$project$Update_Paddle$stopPaddle(paddle)
					});
			case 39:
				return _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Keys$resetGame = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{game: _user$project$Model_Game$initGame, ball: _user$project$Model_Ball$initBall, bricks: _user$project$Model_Bricks$initBricks, paddle: _user$project$Model_Paddle$initPaddle});
};
var _user$project$Keys$startBall = function (model) {
	var newBall = model.ball;
	var newGame = model.game;
	var _p2 = model.game.state;
	switch (_p2.ctor) {
		case 'Start':
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					game: _elm_lang$core$Native_Utils.update(
						newGame,
						{state: _user$project$Model_Game$Play}),
					ball: _elm_lang$core$Native_Utils.update(
						newBall,
						{
							velocity: {x: 2, y: 2}
						})
		...
		case 'Play':
			return model;
		default:
			return _user$project$Keys$resetGame(model);
	}
};
var _user$project$Keys$keyDown = F2(
	function (keyCode, model) {
		var _p3 = model;
		var game = _p3.game;
		var paddle = _p3.paddle;
		var _p4 = keyCode;
		switch (_p4) {
			case 37:
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						paddle: A2(_user$project$Update_Paddle$movePaddle, paddle, -5)
					});
			case 39:
				return _elm_lang$core$Native_Utils.update(
					model,
			...
			case 32:
				return _user$project$Keys$startBall(model);
			default:
				return model;
		}
	});

var _user$project$Subscriptions$keyUp = _elm_lang$keyboard$Keyboard$ups(_user$project$Messages$KeyUp);
var _user$project$Subscriptions$keyDown = _elm_lang$keyboard$Keyboard$downs(_user$project$Messages$KeyDown);
var _user$project$Subscriptions$tick = _elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Messages$TickUpdate);
var _user$project$Subscriptions$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Subscriptions$tick,
			_1: {
				ctor: '::',
				_0: _user$project$Subscriptions$keyDown,
				_1: {
					ctor: '::',
					_0: _user$project$Subscriptions$keyUp,
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Update_Bricks$hasBallHitBrick = F2(
	function (ballPosition, brick) {
		var ballCenterX = ballPosition.x + _elm_lang$core$Basics$round(0.5 * _user$project$Constants$ballAttributes.width);
		var brickEndY = brick.position.y + _user$project$Constants$brickAttributes.height;
		var brickStartY = brick.position.y;
		var brickEndX = brick.position.x + _user$project$Constants$brickAttributes.width;
		var brickStartX = brick.position.x;
		return (_elm_lang$core$Native_Utils.cmp(ballCenterX, brickStartX) > 0) && ((_elm_lang$core$Native_Utils.cmp(ballCenterX, brickEndX) < 0) && ((_elm_lang$core$Native_Utils.cmp(ballPosition.y + _user$project$Constants$ballAttributes.height, brickStartY) > 0) && (_elm_lang$core$Native_Utils.cmp(ballPosition.y, brickEndY) < 0)));
	});
var _user$project$Update_Bricks$notCollidedBricks = F2(
	function (bricks, ball) {
		return A2(
			_elm_lang$core$List$filter,
			function (brick) {
				return !A2(_user$project$Update_Bricks$hasBallHitBrick, ball.position, brick);
			},
			bricks);
	});
var _user$project$Update_Bricks$updateNumberOfBricks = function (model) {
	var _p0 = model;
	var ball = _p0.ball;
	var bricks = _p0.bricks;
	var remainingBricks = A2(_user$project$Update_Bricks$notCollidedBricks, bricks, ball);
	return _elm_lang$core$Native_Utils.update(
		model,
		{bricks: remainingBricks});
};

var _user$project$Update_Collisions$doesBallHitBrick = F2(
	function (bricks, ball) {
		return !_elm_lang$core$Native_Utils.eq(
			bricks,
			A2(_user$project$Update_Bricks$notCollidedBricks, bricks, ball));
	});
var _user$project$Update_Collisions$doesBallHitPaddle = F2(
	function (ballPosition, paddlePosition) {
		var ballCenter = ballPosition.x + _elm_lang$core$Basics$round(0.5 * _user$project$Constants$ballAttributes.width);
		return (_elm_lang$core$Native_Utils.cmp(ballCenter, paddlePosition) > 0) && ((_elm_lang$core$Native_Utils.cmp(ballCenter, paddlePosition + _user$project$Constants$paddleAttributes.width) < 0) && (_elm_lang$core$Native_Utils.cmp(ballPosition.y + _user$project$Constants$ballAttributes.height, _user$project$Constants$paddleAttributes.yPosition) > -1));
	});
var _user$project$Update_Collisions$doesBallHitCeiling = function (ballPosition) {
	return _elm_lang$core$Native_Utils.cmp(ballPosition.y, 0) < 1;
};
var _user$project$Update_Collisions$doesBallHitWall = function (ballPosition) {
	return (_elm_lang$core$Native_Utils.cmp(ballPosition.x, 0) < 1) || (_elm_lang$core$Native_Utils.cmp(ballPosition.x, _user$project$Constants$gameAttributes.width) > -1);
};

var _user$project$Update_Ball$hasBallFallen = function (position) {
	return _elm_lang$core$Native_Utils.cmp(position.y, _user$project$Constants$gameAttributes.height) > -1;
};
var _user$project$Update_Ball$handleYCollisions = F3(
	function (bricks, ball, paddlePosition) {
		var _p0 = ball;
		var position = _p0.position;
		var velocity = _p0.velocity;
...
var _user$project$Update_Ball$handleXCollisions = function (ball) {
	...
	var velocity = _p1.velocity;
	return _user$project$Update_Collisions$doesBallHitWall(position) ? (velocity.x * -1) : velocity.x;
};
var _user$project$Update_Ball$velocityFromCollisions = function (model) {
	var _p2 = model;
	var ball = _p2.ball;
	var bricks = _p2.bricks;
	var paddle = _p2.paddle;
	var _p3 = ball;
	var position = _p3.position;
	return _user$project$Update_Ball$hasBallFallen(position) ? {x: 0, y: 0} : {
		x: _user$project$Update_Ball$handleXCollisions(ball),
		y: A3(_user$project$Update_Ball$handleYCollisions, bricks, ball, paddle.position)
	};
};
var _user$project$Update_Ball$updateVelocity = function (model) {
	var newBall = model.ball;
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			ball: _elm_lang$core$Native_Utils.update(
				newBall,
				{
					velocity: _user$project$Update_Ball$velocityFromCollisions(model)
				})
		});
};
var _user$project$Update_Ball$addVelocityToPosition = function (ball) {
	var _p4 = ball;
	var position = _p4.position;
	var velocity = _p4.velocity;
	var positionPlusVelocity = {x: position.x + velocity.x, y: position.y + velocity.y};
	return _user$project$Update_Ball$hasBallFallen(position) ? _user$project$Constants$ballAttributes.startPosition : positionPlusVelocity;
};
var _user$project$Update_Ball$updatePosition = function (model) {
	var _p5 = model;
	var ball = _p5.ball;
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			ball: _elm_lang$core$Native_Utils.update(
				ball,
				{
					position: _user$project$Update_Ball$addVelocityToPosition(ball)
				})
		});
};
var _user$project$Update_Ball$updateBall = function (model) {
	return _user$project$Update_Ball$updateVelocity(
		_user$project$Update_Ball$updatePosition(model));
};

var _user$project$Update_Game$brickScore = function (ballPosition) {
	return (_elm_lang$core$Native_Utils.cmp(ballPosition.y, _user$project$Constants$brickLayout.yMargin + (_user$project$Constants$brickAttributes.height * 2)) < 0) ? _user$project$Constants$brickPoints.high : ((_elm_lang$core$Native_Utils.cmp(ballPosition.y, _user$project$Constants$brickLayout.yMargin + (_user$project$Constants$brickAttributes.height * 4)) < 0) ? _user$project$Constants$brickPoints.middle : _user$project$Constants$brickPoints.low);
};
var _user$project$Update_Game$updateGameState = function (model) {
	var newGame = model.game;
	var newState = _user$project$Update_Ball$hasBallFallen(model.ball.position) ? _user$project$Model_Game$Start : ((_elm_lang$core$Native_Utils.eq(model.game.lives, 0) || _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$List$length(model.bricks),
		0)) ? _user$project$Model_Game$Gameover : model.game.state);
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			game: _elm_lang$core$Native_Utils.update(
...
var _user$project$Update_Game$updateScore = function (model) {
	var newGame = model.game;
	var _p0 = model;
	var ball = _p0.ball;
	var bricks = _p0.bricks;
	...
	var score = _p2.score;
	var state = _p2.state;
	return A2(_user$project$Update_Collisions$doesBallHitBrick, bricks, ball) ? _elm_lang$core$Native_Utils.update(
		model,
		{
			game: _elm_lang$core$Native_Utils.update(
				newGame,
				{
					score: score + _user$project$Update_Game$brickScore(position)
				})
		}) : model;
};
var _user$project$Update_Game$updateLives = function (model) {
	var newGame = model.game;
	var _p3 = model.ball;
	var position = _p3.position;
	var _p4 = model.game;
	var lives = _p4.lives;
	var state = _p4.state;
	return (_user$project$Update_Ball$hasBallFallen(position) && (!_elm_lang$core$Native_Utils.eq(state, _user$project$Model_Game$Gameover))) ? _elm_lang$core$Native_Utils.update(
		model,
		{
			game: _elm_lang$core$Native_Utils.update(
				newGame,
...
var _user$project$Update_Game$updateGame = function (model) {
	var _p5 = model;
	var game = _p5.game;
	var ball = _p5.ball;
	return _user$project$Update_Game$updateGameState(
		_user$project$Update_Game$updateScore(
			_user$project$Update_Game$updateLives(model)));
};

var _user$project$Update$gameLoop = function (model) {
	return _user$project$Update_Paddle$updatePaddle(
		_user$project$Update_Bricks$updateNumberOfBricks(
			_user$project$Update_Game$updateGame(
				_user$project$Update_Ball$updateBall(model))));
};
var _user$project$Update$data = _elm_lang$core$Native_Platform.outgoingPort(
	'data',
	function (v) {
		return v;
	});
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'KeyDown':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Keys$keyDown, _p0._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'KeyUp':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Keys$keyUp, _p0._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
...
var _user$project$View_StyleSheet$colours = {
...
var _user$project$View_StyleSheet$Bricks = function (a) {
	return {ctor: 'Bricks', _0: a};
};
var _user$project$View_StyleSheet$Ball = {ctor: 'Ball'};
var _user$project$View_StyleSheet$Paddle = {ctor: 'Paddle'};
var _user$project$View_StyleSheet$Game = {ctor: 'Game'};
...
var _user$project$View_StyleSheet$stylesheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		...
		_0: A2(
			...
			_user$project$View_StyleSheet$WindowBackground,
			{ctor: '[]'}),
		_1: {
			ctor: '::',
			_0: A2(
...
var _user$project$View$makeBlock = F5(
	function (x_, y_, width_, height_, styleClass) {
		return A3(
			...
			styleClass,
			{
				...
				_0: _mdgriffith$style_elements$Element_Attributes$width(
					_mdgriffith$style_elements$Element_Attributes$px(width_)),
				_1: {
					ctor: '::',
					_0: _mdgriffith$style_elements$Element_Attributes$height(
						_mdgriffith$style_elements$Element_Attributes$px(height_)),
					_1: {
						ctor: '::',
						_0: A2(_mdgriffith$style_elements$Element_Attributes$spacingXY, x_, y_),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _user$project$View$assignBrickColour = function (row) {
	var _p0 = row;
	switch (_p0) {
		case 0:
...
var _user$project$View$displayBall = F2(
	function (x, y) {
		return A5(
			_user$project$View$makeBlock,
			_elm_lang$core$Basics$toFloat(x),
			_elm_lang$core$Basics$toFloat(y),
			_user$project$Constants$ballAttributes.width,
			_user$project$Constants$ballAttributes.height,
			_user$project$View_StyleSheet$Ball);
	});
var _user$project$View$view = function (model) {
	var nodes = {
		ctor: '::',
		_0: _user$project$View$displayPaddle(
			_elm_lang$core$Basics$toFloat(model.paddle.position)),
		_1: {
			ctor: '::',
			_0: A2(_user$project$View$displayBall, model.ball.position.x, model.ball.position.y),
			_1: A2(_elm_lang$core$List$map, _user$project$View$displayBricks, model.bricks)
		}
	};
	return A2(
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Model$init, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$Subscriptions$subscriptions})();
