...
async function collectCoverage() {
  ...
  const collectPromises = EVENTS.map(async event => {
    ...
    const pageData = await page.evaluateHandle(() => FormData.prototype)
    const queryObjects = await page.queryObjects(pageData);

    console.log('evaluateHandle START')
    console.log(pageData)
    console.log('evaluateHandle END')


    console.log('queryObjects START')
    console.log(queryObjects)
    console.log('queryObjects END')
